...
<head>
    ...
    <style>
        ...
        .c-nav-links a:hover::after, .c-nav-links a.active::after { width: 100%; }
        .c-nav-actions { display: flex; gap: 15px; }
        ...
        /* Page Hero */
        .page-hero { padding: 15rem 0 5rem; text-align: center; }
        .page-hero-title { font-size: clamp(3rem, 7vw, 6rem); line-height: 1; letter-spacing: -0.02em; margin-bottom: 2rem; color: #fff; text-transform: uppercase; }
        .page-hero-title span { color: var(--accent); font-style: italic; }
        .page-hero-sub { font-family: 'Inter', sans-serif; font-size: 1.1rem; color: #ccc; max-width: 600px; margin: 0 auto; line-height: 1.8; font-weight: 300; }

        /* Mission Image Reveal */
        .reveal-sec { height: 80vh; margin: 5rem 0; position: relative; display: flex; align-items: center; justify-content: center; background: #fff; color: var(--bg-dark); }
        .reveal-bg { position: absolute; inset: 0; overflow: hidden; clip-path: inset(15% 15% 15% 15%); }
        .reveal-bg img { width: 100%; height: 100%; object-fit: cover; filter: grayscale(20%); }
        .reveal-content { z-index: 10; text-align: center; }
        .reveal-text { font-family: 'Playfair Display', serif; font-size: clamp(3rem, 8vw, 8rem); line-height: 0.9; color: #fff; font-style: italic; text-shadow: 0 10px 30px rgba(0,0,0,0.5); }
        ...
        .sec-title { font-size: clamp(2.5rem, 5vw, 4.5rem); line-height: 1.1; margin-bottom: 4rem; }
        .sec-title span { color: var(--accent); font-style: italic; }

        /* Story Grid */
        .story-text { color: var(--text-muted); font-size: 1.1rem; line-height: 1.8; font-weight: 300; margin-bottom: 2rem; }
        .story-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; }
        .story-img-wrap { overflow: hidden; height: 600px; position: relative; }
        .story-img { position: absolute; top: -15%; width: 100%; height: 130%; object-fit: cover; filter: grayscale(30%); }

        /* Values */
        .value-card { border-top: 1px solid rgba(255,255,255,0.1); padding-top: 2rem; transition: transform 0.4s; }
        .value-card:hover { transform: translateY(-10px); }
        .value-num { font-size: 0.85rem; color: var(--accent); letter-spacing: 0.15em; margin-bottom: 1.5rem; display: block; }
        .value-title { font-size: 1.8rem; margin-bottom: 1.5rem; color: #fff; }
        .value-desc { color: var(--text-muted); line-height: 1.8; font-weight: 300; font-size: 1.05rem; }
...
<body>
    ...
    <main>
        ...
        <section class="page-hero">
            <div class="container">
                <h1 class="page-hero-title gsap-reveal">About <span>Us.</span></h1>
                <p class="page-hero-sub gsap-reveal-delay">Empowering the next generation of professionals by bridging talented students with the opportunities they deserve.</p>
            </div>
        </section>
        ...
        <section class="reveal-sec">
            <div class="reveal-bg">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=2400" alt="Team">
            </div>
            <div class="reveal-content">
                <div class="reveal-text">Building<br>Bridges.</div>
            </div>
        </section>
        ...
        <section class="sec-padding">
            <div class="container">
                <div class="story-grid">
                    <div>
                        <h2 class="sec-title gsap-up">Our <span>Story</span>.</h2>
                        <p class="story-text gsap-up" style="transition-delay:0.1s;">At Conneto, we believe every individual possesses the potential for greatness, provided they are given the right platform. Founded on the frustration of finding quality internships in an ocean of noise, we sought to bring clarity, elegance, and efficiency to the hiring space.</p>
                        <p class="story-text gsap-up" style="transition-delay:0.2s;">Today, we have matured into a premier network, facilitating thousands of professional connections between elite talent and verified corporate partners across India. This is just the beginning.</p>
                    </div>
                    <div class="story-img-wrap plx-wrapper">
                        <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&q=80&w=1600" alt="Office" class="story-img plx-img">
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Marquee 1 -->
        <section class="marquee-container" style="background:var(--accent);color:#fff;">
            <div class="marquee-inner" id="mq1">
                <div class="marquee-text" style="color:#fff;">TRUST • TRANSPARENCY • QUALITY • VELOCITY • </div>
                <div class="marquee-text" style="color:#fff;">TRUST • TRANSPARENCY • QUALITY • VELOCITY • </div>
                <div class="marquee-text" style="color:#fff;">TRUST • TRANSPARENCY • QUALITY • VELOCITY • </div>
            </div>
        </section>
        ...
        <section class="sec-padding">
            <div class="container">
                <h2 class="sec-title gsap-up text-center">Core <span>Principles</span></h2>
                <div class="row gy-5 mt-5">
                    <div class="col-md-4">
                        <div class="value-card gsap-up">
                            <span class="value-num">01 — STUDENT FIRST</span>
                            <h4 class="value-title">Empathy</h4>
                            <p class="value-desc">Every architectural decision in our platform prioritizes the student experience, ensuring seamless discovery.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="value-card gsap-up" style="transition-delay: 0.1s;">
                            <span class="value-num">02 — TRUST</span>
                            <h4 class="value-title">Verification</h4>
                            <p class="value-desc">Integrity is paramount. Every corporate partner undergoes rigorous manual curation before accessing our network.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="value-card gsap-up" style="transition-delay: 0.2s;">
                            <span class="value-num">03 — INNOVATION</span>
                            <h4 class="value-title">Evolution</h4>
                            <p class="value-desc">We continuously refine our algorithmic matching to ensure precision and speed in every placement.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        window.addEventListener('load', () => {
            gsap.from('.gsap-reveal', { y: 100, opacity: 0, duration: 1.5, ease: "power4.out", delay: 0.2 });
            gsap.from('.gsap-reveal-delay', { y: 50, opacity: 0, duration: 1.5, ease: "power4.out", delay: 0.4 });
        });
        ...
        gsap.to(".plx-img", {
            ...
            scrollTrigger: { trigger: ".plx-wrapper", start: "top bottom", end: "bottom top", scrub: true }
        });

        gsap.to("#mq1", { xPercent: -50, ease: "none", scrollTrigger: { trigger: ".marquee-container", start: "top bottom", end: "bottom top", scrub: 1 }});
