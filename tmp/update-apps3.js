...
const sidebarMatch = companyContent.match(/(<div class="sidebar-overlay"[\s\S]*?<\/aside>)/);
...
let sidebarHtml = sidebarMatch[1];
...
eval(newAppsHtml); // This is just a test to make sure syntax is valid
